...
--
-- Host: localhost    Database: maisha
-- ------------------------------------------------------
...
CREATE TABLE `contact_organization` (
  ...
  CONSTRAINT `contact_organization_image_id_0dbb7c41_fk_media_image_id` FOREIGN KEY (`image_id`) REFERENCES `media_image` (`id`),
...
INSERT INTO `contact_organization` VALUES (2,0,'Maisha Girls Safe House','Maisha Girls Safe House fills a gap that is experienced by survivors of sexual violence. The Safe House offers young women opportunities for case management and community integration. Additionally, Maisha creates links to institutions assisting in rehabilitation, long term housing, treatment, education, and independence.','The projects mission is to reach out, receive and protect girls in the most vulnerable situations of sexual violence and abuses.','To end sexual violence against girls and young women.','...',2,2,3,NULL,'2024-04-03 15:22:23.527990',NULL,NULL,0,'2024-04-03 15:22:23.645546',NULL);
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2024-04-08 17:12:43.501420'),(2,'contenttypes','0002_remove_content_type_name','2024-04-08 17:13:16.061711'),(3,'media','0001_initial','2024-04-08 17:13:16.078922'),(4,'about','0001_initial','2024-04-08 17:13:16.097070'),(5,'about','0002_initial','2024-04-08 17:13:16.117843'),(6,'auth','0001_initial','2024-04-08 17:13:16.153252'),(7,'admin','0001_initial','2024-04-08 17:13:16.167632'),(8,'admin','0002_logentry_remove_auto_add','2024-04-08 17:13:16.180846'),(9,'admin','0003_logentry_add_action_flag_choices','2024-04-08 17:13:16.226885'),(10,'auth','0002_alter_permission_name_max_length','2024-04-08 17:13:16.252002'),(11,'auth','0003_alter_user_email_max_length','2024-04-08 17:13:16.292657'),(12,'auth','0004_alter_user_username_opts','2024-04-08 17:13:16.301853'),(13,'auth','0005_alter_user_last_login_null','2024-04-08 17:13:16.330446'),(14,'auth','0006_require_contenttypes_0002','2024-04-08 17:13:16.332631'),(15,'auth','0007_alter_validators_add_error_messages','2024-04-08 17:13:16.340880'),(16,'auth','0008_alter_user_username_max_length','2024-04-08 17:13:16.366567'),(17,'auth','0009_alter_user_last_name_max_length','2024-04-08 17:13:16.393788'),(18,'auth','0010_alter_group_name_max_length','2024-04-08 17:13:16.418117'),(19,'auth','0011_update_proxy_permissions','2024-04-08 17:13:16.436299'),(20,'auth','0012_alter_user_first_name_max_length','2024-04-08 17:13:16.463426'),(21,'contact','0001_initial','2024-04-08 17:13:16.477342'),(22,'contact','0002_initial','2024-04-08 17:16:10.263930'),(23,'partnership','0001_initial','2024-04-08 17:16:25.262446'),(24,'programs','0001_initial','2024-04-08 17:16:25.305263'),(25,'sessions','0001_initial','2024-04-08 17:16:25.351259'),(26,'trash','0001_initial','2024-04-08 17:16:25.375960'),(27,'trash','0002_trash_created_at_trash_deleted_at_and_more','2024-04-08 17:26:09.015685');
...
CREATE TABLE `partnership_partner` (
  ...
  CONSTRAINT `partnership_partner_logo_id_5f6226cb_fk_media_image_id` FOREIGN KEY (`image_id`) REFERENCES `media_image` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `trash_trash`
--

DROP TABLE IF EXISTS `trash_trash`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trash_trash` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `object_id` int unsigned NOT NULL,
  `deletion_date` datetime(6) DEFAULT NULL,
  `content_type_id` int NOT NULL,
  ...
  `updated_at` datetime(6) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `trash_trash_content_type_id_4cd3c997_fk_django_content_type_id` (`content_type_id`),
  CONSTRAINT `trash_trash_content_type_id_4cd3c997_fk_django_content_type_id` FOREIGN KEY (`content_type_id`) REFERENCES `django_content_type` (`id`),
  CONSTRAINT `trash_trash_chk_1` CHECK ((`object_id` >= 0))
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `trash_trash`
--

LOCK TABLES `trash_trash` WRITE;
/*!40000 ALTER TABLE `trash_trash` DISABLE KEYS */;
INSERT INTO `trash_trash` VALUES (4,4,'2024-05-08 17:49:17.896864',9,'2024-04-08 17:44:25.597805','2024-04-08 17:49:17.896860',1,'2024-04-08 17:49:17.896938'),(6,4,'2024-05-08 17:49:44.320802',33,'2024-04-08 17:49:17.900291','2024-04-08 17:49:44.320799',1,'2024-04-08 17:49:44.320870'),(7,6,'2024-05-08 17:49:44.320802',33,'2024-04-08 17:49:44.321897',NULL,0,'2024-04-08 17:49:44.321921'),(8,43,'2024-05-08 17:51:04.181407',9,'2024-04-08 17:51:04.184309',NULL,0,'2024-04-08 17:51:04.184336');
/*!40000 ALTER TABLE `trash_trash` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-04-08 18:04:32
